...
export default function AgendaProfessor() {
  ...
  const eventos = useMemo(() => {
    ...
    reunioes.forEach((reuniao) => {
      ...
      const orientador = reuniao.orientador_id
        ? nomeUtilizador(reuniao.orientador_id)
        : null;
      ...
      lista.push({
        ...
        orientadorNome: orientador || "Não indicado",
        ...
        orientadorId: reuniao.orientador_id,
      });
    });
  ...
  function voltarPaginaAnterior() {
    ...
    if (origem === "verReunioesAluno" && edicaoIdParam) {
      router.replace({
        pathname: "/professor/verEstagio/reunioes/reunioes" as any,
        params: {
          inscricaoId: inscricaoIdParam,
          alunoId: alunoIdParam,
          edicaoId: edicaoIdParam,
          ...
          <>
            <View style={styles.mesHeader}>
              <Pressable style={styles.setaMes} onPress={() => mudarMes(-1)}>
                <Ionicons name="chevron-back-outline" size={30} color="#160909" />
              </Pressable>
                  ...
                  <Pressable
                    ...
                    onPress={() => {
                      if (evento.tipo === "reuniao") {
                        router.push({
                          pathname:
                            "/professor/reunioes/verReunioes/verReunioes" as any,
                          params: {
                            edicaoId: String(evento.edicaoId || ""),
                          },
                        });
                      } else if (evento.edicaoId) {
                        router.push({
                          pathname:
                    ...
                    {evento.tipo === "reuniao" ? (
                      <>
                        ...
                        <View style={styles.infoLinhaEvento}>
                          ...
                          <Text style={styles.infoTextoEvento}>
                            Orientador:{" "}
                            {evento.orientadorNome || "Não indicado"}
                          </Text>
                        </View>
                      </>
                    ) : (
