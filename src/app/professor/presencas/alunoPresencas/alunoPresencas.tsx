...
import styles from "./alunoPresencasStyles";
...
export default function AlunosPresencasProfessor() {
  ...
  async function carregarDados() {
    ...
    if (inscricoesIds.length > 0) {
      const { data: presencasData, error: presencasError } = await supabase
        .from("presencas")
        .select("id, inscricao_id, estado_professor")
      ...
      if (presencasError) {
        ...
        const resumos = inscricoesIds.map((inscricaoId) => {
          ...
          const validadas = presencasDaInscricao.filter(
            (presenca: any) => presenca.estado_professor === "validado"
          ).length;
    ...
    <View style={styles.page}>
      ...
      >
        ...
        <Text style={styles.subtitulo}>
          Aqui aparecem apenas os alunos que ainda precisam de validação.
        </Text>
              ...
              <View style={styles.dropdown}>
                ...
                >
                  <Text
                    style={[
                      styles.opcaoTexto,
                      anoSelecionado === "todos" && styles.opcaoTextoSelecionada,
                    ]}
                  >
                    Todos
                  </Text>
                ...
                {anosDisponiveis.map((ano) => (
                  ...
                  >
                    <Text
                      style={[
                        styles.opcaoTexto,
                        anoSelecionado === ano && styles.opcaoTextoSelecionada,
                      ]}
                    >
                      {ano}.º ano
                    </Text>
                ...
                {linhasFiltradas.map((linha) => (
                  ...
                  >
                    ...
                    <Text style={styles.estagioTexto}>
                      ...
                      .º ano · {linha.edicao?.instituicoes?.nome || "Instituição"} ·{" "}
                    ...
                    <View style={styles.infoLinha}>
                      <View style={styles.infoBox}>
                        <Text style={styles.infoNumero}>{linha.resumo.total}</Text>
